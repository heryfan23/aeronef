from PyQt6.QtWidgets import QCompleter, QLineEdit, QWidget, QLabel, QPushButton,QFrame,QTableWidget,QDateEdit, QTableWidgetItem, QComboBox, QMessageBox, QAbstractItemView, QMenu, QDialog, QVBoxLayout, QHBoxLayout, QGridLayout
...
class Directives(QFrame):
    def __init__(self, parent=None):
        ...
        self.filter_label.setGeometry(600, 70, 160, 30)
        self.filter_label.setStyleSheet("color:white; font-size:14px; background-color:None")
        self.filter_input = QLineEdit(self)
        self.filter_input.setGeometry(770, 70, 200, 30)
